%% Create RGB images and videos from optical scenes:
% M.Brechbühler, GEO441

% define your working directory
%DataDir = 'S:/course/geo441/data/2020_Camargue/';
DataDir = 'W:\Desktop\GEO441\data\';
optical = [DataDir 'FR_L8_original_filt\'];
cd(optical);
...
v = VideoWriter('W:/Desktop/geo441/output/L8_composite_indices_150dpi_3fps', 'MPEG-4');
v.FrameRate = 3; % Number of frames per second
open(v);
...
for fn = 1:length(files)
    ...
    position = [50 50]; 
    box_color = 'yellow';
    im3_overlay = insertText(im3,position,date(fn),'FontSize',100,'BoxColor',box_color,'BoxOpacity',0.4,'TextColor','white');
    imshow(im3_overlay);
